...
mklink /D "%path_wrath%\Diminish" "%path_projects%\Diminish\.release\Diminish"
mklink /D "%path_wrath%\Diminish_Options" "%path_projects%\Diminish\.release\Diminish_Options"
