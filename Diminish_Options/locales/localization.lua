...
L["HEADER_MISC"] = "Misc"
L["HEADER_PROFILES"] = "Modify configuration profiles so you can have different settings for every character. See tooltips for more info."
...
L["USEPROFILE"] = "Use"
L["USEPROFILE_TOOLTIP"] = "Set existing profile to use for this character. Any modifications to the profile will affect all characters using the profile."
